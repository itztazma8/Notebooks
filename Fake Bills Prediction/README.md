...
The accuracy score, when checked, ensures that the labels predicted were the right ones.
**Now at times the result can be (1-0.99...) as labels- 0 and 1 are interchanged in many iterations.**
